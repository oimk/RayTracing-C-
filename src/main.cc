...
int main()
{
    ...
    //Setting up Viewport/Camera. Width is real valued.
    auto focal_length = 1.0;
    auto viewport_height = 2.0;
    auto viewport_width = viewport_height * (double(image_height)/image_height);
    ...
    //Caculate the distance between pixels 
    auto pixel_delta_u = viewport_u / image_height;
    auto pixel_delta_v = viewport_v / image_height;

    //Caculate location of upper left pixel 
